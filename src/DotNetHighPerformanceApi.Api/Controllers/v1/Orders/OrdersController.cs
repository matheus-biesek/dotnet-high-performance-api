using DotNetHighPerformanceApi.Application.Features.Orders.v1.Commands.CreateOrder;
using DotNetHighPerformanceApi.Application.Features.Orders.v1.Commands.UpdateOrder;
using DotNetHighPerformanceApi.Application.Features.Orders.v1.DTOs;
using DotNetHighPerformanceApi.Application.Features.Orders.v1.Queries.GetOrderById;
using MediatR;
